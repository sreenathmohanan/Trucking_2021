...
/**
 * CAP116 : List Global Customer Allotments
 * @author A-7868 Krishna <08/05/2018>
 *
 */
public class CAP116 extends BasePage{
    ...
    public CAP116(WebDriver driver, String dataFileName) {
		 super(driver);
        this.driver = driver;
    ...
    {
    	txt_carrCode= MiscUtility.getWebElement(objFilepath,"CAP116_txt_carrCode");
    	txt_fltNo= MiscUtility.getWebElement(objFilepath,"CAP116_txt_fltNo");
    	tbl_allotmnt= MiscUtility.getWebElement(objFilepath,"CAP116_tbl_allotmnt");    	
    	btn_list= MiscUtility.getWebElement(objFilepath,"CAP116_btn_list");
    	btn_close = MiscUtility.getWebElement(objFilepath,"CAP116_btn_close");
     ...
     * @author A-7868 Krishna <08/05/2018>
     */
    public CAP116 listFlightAndVerifyAllotment(String carrCode, String fltNum, String allotId){
